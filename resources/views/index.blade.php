		...
		<div class="container">
			<div class="row">
				<div class="col-md-offset-1 col-md-11">
					<h2 class="title">Mening <strong>Ishlarim</strong></h2>						
				</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-6 col-sm-6">					
					<h2 class="title">Mening <strong>rezyumeyim</strong></h2>
					<p><span class="tm-info-label">Name</span> Murodjon Shomuratov</p>
					<p><span class="tm-info-label">Birthday</span> 17-mart, 1997-yil</p>
					<p><span class="tm-info-label">Address</span> O`zbekiston Respublikasi, Xorazm viloyati</p>
					<p><span class="tm-info-label">Phone</span> +99890 433 36 99</p>
					<p><span class="tm-info-label">Email</span> murodbek.0338@gmail.com</p>
					<p><span class="tm-info-label">Website</span> <a href="#" class="tm-red-text">www.ultrasoft.com</a></p>
				</div>
				<div class="col-md-6 col-sm-6">
		...
		<div class="container">
			<div class="row">
				<div class="col-md-offset-6 col-md-6 col-sm-offset-6 col-sm-7">
					<div class="title">
						<h2>Bu <strong>men</strong></h2>
						<h1 class="tm-red-text">Bosh <strong>Direktor</strong></h1>
					</div>
			...
			<div class="row">
				...
				<div class="col-md-10 col-sm-10">
					<form action="#" method="post">
						<div class="col-md-6 col-sm-6">
							<input class="form-control" type="text" placeholder="Isminggiz">
						</div>
						<div class="col-md-6 col-sm-6">
							<input class="form-control" type="email" placeholder="email pochtangiz">
						</div>
						<div class="col-md-12 col-sm-12">
							<input class="form-control" type="text" placeholder="Mavzu">
							<textarea class="form-control" placeholder="Xabaringgiz" rows="6"></textarea>
						</div>
